...
Public Class Report_cust_details_Form12_
    ...
    Private Sub Button1_Click(sender As Object, e As EventArgs) Handles Button1.Click
        ...
        Using connection As New SqlConnection("Data Source=AVITA-LIBER-V14;Initial Catalog=bike db;Integrated Security=True")
            Dim adapter As New SqlDataAdapter("SELECT * FROM CustDet", connection)
            Dim builder As New SqlCommandBuilder(adapter)
            adapter.Update(dataTable)
        End Using
    End Sub

    'establishing connection and making changes from dgv'
    Private Sub Report_cust_details_Form12__Load(sender As Object, e As EventArgs) Handles MyBase.Load
    ...
    'code for printing the db table'
    ...
    Private Sub Report_cust_details_Form12__Load_1(sender As Object, e As EventArgs) Handles MyBase.Load
